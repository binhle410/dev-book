...
namespace Bean\Bundle\SonataMediaBundle;
 ...
 * @author Binh
 */
class BeanSonataMediaBundle extends Bundle {
	public function build(ContainerBuilder $container) {
		parent::build($container);
		$container->addCompilerPass(
			DoctrineOrmMappingsPass::createXmlMappingDriver(
				[
					realpath(__DIR__ . '/Resources/config/doctrine-base') => 'Bean\Bundle\SonataMediaBundle\Doctrine\Orm',
				],
